...
// LED control
String presetEffects[] = { "static", "flash", "pulse", "double_flash", "cycle", "lightbulb_off" };
String presetColors[] = { "green", "cyan", "white", "aqua", "blue", "red" };
...
void sendVariable(String id) {
  ...
  else if (id == "p_h1_delta") Serial.println(pHeater1DeltaTemp);
  else if (id == "p_h2_delta") Serial.println(pHeater2DeltaTemp);
