...
// Heating control
float roomTemp = 2.3, releaseTemp = 3.4, returnTemp = 4.5,
      pRoomTemp = 2.0, pRoomIntTemp = 4.5, pHeater1DeltaTemp = 3.5,
      pHeater2DeltaTemp = 3.5, pPumpDeltaTemp = 3.5;
...
String currentEffect = "p", currentColor = "#00ff00";
...
void sendVariable(String id) {
  if (id == "all") {
    ...
    Serial.flush();
    delay(30);
    sendVariable("p_room_int");
    Serial.flush();
    delay(30);
    sendVariable("p_heater_1_delta");
    Serial.flush();
    delay(30);
    sendVariable("p_heater_2_delta");
    Serial.flush();
    delay(30);
    sendVariable("p_pump_delta");
    Serial.flush();
    delay(30);
    sendVariable("heater_1");
    Serial.flush();
    delay(30);
    sendVariable("heater_2");
    Serial.flush();
    delay(30);
    sendVariable("pump");
    Serial.flush();
    delay(30);
    sendVariable("heating_mode");
    Serial.flush();
    delay(30);
    sendVariable("current_effect");
    Serial.flush();
    delay(30);
    sendVariable("current_color");
    delay(30);
    Serial.flush();
    // sendVariable("temperature_history"); Serial.flush();  delay(30);
    // sendVariable("consumption_history"); Serial.flush();  delay(30);
    // sendVariable("preset_colors");
    // Serial.flush();
    // delay(30);
    sendVariable("preset_effects");
    Serial.flush();
    delay(30);
    sendVariable("show_current_effect");
    Serial.flush();
    delay(30);
    sendVariable("active_preset");
    Serial.flush();
    delay(30);
    return;
  }
  ...
  if (id == "temperature_history"
      ...
      || id == "preset_effects"
      || id == "preset_colors"
      || id == "preset_colors_all")
    Serial.print("+");
  else
    Serial.print("-");

  if(id == "preset_colors_all")
    Serial.print("preset_colors: ");
  else
    Serial.print(id + ": ");
  ...
  //else if (id == "preset_colors") Serial.println(arrayToString(presetColors) + "\r");
  ...
  // selse if (id == "consumption_history") Serial.println(arrayToString(consumptionHistory) + "\r\n");
